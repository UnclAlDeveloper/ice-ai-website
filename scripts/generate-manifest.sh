...
if [ "$SERVICE_NAME" = "ice-ai-website" ]; then
    export ICE_AI_DATABASE_URL ANNA_TRAINER_DATABASE_URL AUTO_ADS_DATABASE_URL NEXT_PUBLIC_AUTO_ADS_ELEVENLABS_API_KEY NEXT_PUBLIC_AUTO_ADS_ELEVENLABS_VOICE_ID NEXT_PUBLIC_ELEVENLABS_TEXT2SPEECH_MODEL_NAME AUTO_ADS_GOOGLE_API_KEY GEMINI_MODEL_NAME DVLA_API_KEY
fi
